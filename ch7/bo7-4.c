...
void DFSTraverse(AMLGraph G, Status(*visit)(VertexType)) { /* 初始条件: 图G存在,Visit是顶点的应用函数。算法7.4 */
...
#include "../ch3/c3-2.h" /* BFSTraverse()用 */
#include "../ch3/bo3-2.c" /* BFSTraverse()用 */

void BFSTraverse(AMLGraph G, Status(*Visit)(VertexType)) { /* 初始条件: 图G存在,Visit是顶点的应用函数。算法7.6 */

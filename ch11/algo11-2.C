...
#include "../ch10/c10-1.h" /* 定义KeyType、RedType及SqList */
...
void get_run(LoserTree ls, WorkArea wa, int rc, int *rmax, FILE *fi, FILE *fo) { /* 求得一个初始归并段，fi为输入文件指针，fo为输出文件指针。算法11.5 */
    int q;
    KeyType minimax;

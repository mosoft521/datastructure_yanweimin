...
RedType P(RcdType g) { /* 把g加工为q的结构返回 */
    RedType q;
...
void Q(RedType *f, RcdType g) { /* 将f和g归并成一个f结构的记录 */
    (*f).amount += g.amount;
}

void MergeFile(FILE *f, FILE *g, FILE *h) { /* 由按关键字递增有序的非空顺序文件f和g归并得到新文件h，三个文件均已 */
